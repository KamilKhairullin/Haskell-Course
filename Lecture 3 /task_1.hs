...
topArrow :: Picture
topArrow = translated 0 0.7  (lettering  "\x2191")

-- | Draws 'down' arrow of lift panel
bottomArrow :: Picture
bottomArrow = translated 0 (-0.7) (lettering  "\x2193")
...
drawButton Up =  translated 0 (-0.25) (scaled 0.8 0.8 (colored white (lettering  "\x2C5"))) <> templateCircle
drawButton Down =  translated 0 (-0.25) (scaled 0.8 0.8 (colored white (lettering  "\x2C4"))) <> templateCircle
